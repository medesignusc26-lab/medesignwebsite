  ...
  const boardMembers = [
    {
      ...
      role: 'Co-President',
      major: 'Junior, Biomedical Engineering — Cellular & Molecular Emphasis',
      minor: undefined,
      year: 'Junior',
      email: '',
      linkedin: '#',
    ...
    },
    {
      name: 'Anay Gupta',
      role: 'Co-President',
      major: 'Senior, BME — Mechanical Emphasis',
    ...
    },
    {
      ...
      major: 'Sophomore, Biomedical Engineering — Mechanical Emphasis',
      minor: undefined,
      year: 'Sophomore',
      email: '',
      linkedin: '#',
    ...
    },
    {
      name: 'Chloe Xia',
      role: 'Secretary',
      major: 'Junior, Computational Neuroscience',
    ...
    },
    {
      name: 'Devaki Menon',
      role: 'Treasurer',
      major: 'Junior, BME — Electrical Emphasis',
      minor: undefined,
      year: 'Junior',
      email: '',
      linkedin: '#',
    ...
    },
    {
      name: 'Katie Spitzer',
      role: 'Social Chair',
      major: 'Sophomore, Chemical Engineering',
      minor: undefined,
      year: 'Sophomore',
      email: '',
      linkedin: '#',
    ...
    },
    {
      ...
      major: 'Senior, Computational Neuroscience and Biology',
      minor: undefined,
      year: 'Senior',
      email: '',
      linkedin: '#',
